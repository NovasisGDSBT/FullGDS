...
/* Allowed file extensions for DLEDS package version 2 */
#define DLEDS_FILE_EXTENSION_EDSP2      ".edsp2"   /* Obsolete, doesn't follow the file naming conventions */
#define DLEDS_FILE_EXTENSION_EDP2       ".edp2"
