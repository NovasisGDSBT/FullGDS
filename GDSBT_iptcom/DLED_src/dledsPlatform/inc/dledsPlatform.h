...
#define DLEDS_DEBUG_ACTIVE              "/tmp/dleds/DLEDS_DEBUG_ON"

/* Files used by DLEDS for Debugging */
#define DBG_EVENT_LOG         "/tmp/dleds/dledsEvent.log"
#define DBG_EVENT_POS         "/tmp/dleds/dledsEventPos.txt"
#define DBG_FILE_PATH         "/tmp/dleds"
#define MAX_EVENTLOG_SIZE     102400   /* 100kb */

/* Constants for Compact Flash */
#define DLEDS_MAX_PATH_LEN      255
#define DLEDS_MOUNT_FILE_SIZE   2048
#define DLEDS_LINUX_CF          "/dev/mmc2blk"
//#define DLEDS_CSS_CF            "/ata0/"
#define DLEDS_LINUX_MOUNTS      "/tmp/dleds/mounts"
